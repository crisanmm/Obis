...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="/obis/css/about-us.css">
        ...
        <header>
            ...
            <nav>
                <ul class="nav-button-list">
                    ...
                    <li><a href="/obis/home/aboutus" class="nav-button" style="color: #ffd524; font-weight: bolder">About us</a></li>
        ...
        <main>
            ...
            <div class="descriptions">
                <section class="hincean">
                    <img src="/obis/images/placeholders/logo.png">
