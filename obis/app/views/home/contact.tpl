...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="/obis/css/contact.css">
        ...
        <header>
            ...
            <nav>
                <ul class="nav-button-list">
                    ...
                    <li><a href="/obis/home/contact" class="nav-button" style="color: #ffd524; font-weight: bolder">Contact</a></li>
                </ul>
